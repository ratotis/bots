...
window.addEventListener("DOMContentLoaded", () => {
  ...
  style.textContent = `
    body {
      ...
      background: linear-gradient(135deg, #5a1b5d, #1c0326);
      margin: 0;
      padding: 0;
      display: flex;
    ...
    #menu {
      ...
      color: #ffffff;
      border: 3px solid #7d32a8;
      border-radius: 20px;
      padding: 40px 50px;
      box-shadow: 0 0 50px rgba(0, 0, 0, 0.8);
      text-align: center;
      width: 750px; /* Increased width for a rectangular shape */
      height: 400px; /* Reduced height for a rectangular shape */
    ...
    #menu.show {
      ...
      box-shadow: 0 0 80px rgba(125, 50, 168, 0.8), 0 0 120px rgba(125, 50, 168, 0.6);
    }
    ...
    button {
      background: linear-gradient(135deg, #7d32a8, #571975);
      color: #ffffff;
      border: none;
      border-radius: 20px;
      padding: 10px 20px;
      ...
      box-shadow: 0 5px 15px rgba(0, 0, 0, 0.3), 0 0 20px rgba(125, 50, 168, 0.6);
      margin: 10px 0;
      position: relative;
      overflow: hidden;
      width: 60%;
    ...
    button:hover {
      background: linear-gradient(135deg, #571975, #7d32a8);
      transform: scale(1.05);
      box-shadow: 0 8px 25px rgba(0, 0, 0, 0.4), 0 0 30px rgba(125, 50, 168, 0.8);
    }
  ...
  menuTitle.innerText = "Bot Setting";

  const searchBtn = document.createElement("button");
  searchBtn.id = "searchBtn";
  searchBtn.innerText = "Counter";
  ...
  removeBtn.innerText = "Remove Bots";
  ...
  searchBtn.addEventListener("click", function () {
    const numberBots = window.allBots.length;
    outputText.textContent = `Number of bots: ${numberBots}`;
